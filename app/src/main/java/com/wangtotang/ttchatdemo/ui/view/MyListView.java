...
public class MyListView extends ListView implements AbsListView.OnScrollListener {
    ...
    // -- header view
    private HeaderListView mHeaderView;
    ...
    // -- footer view
    private FooterListView mFooterView = null;
    ...
    private void initWithContext(Context context) {
        ...
        m_context = context;
        // init header view
        mHeaderView = new HeaderListView(context);
    ...
    public void pullRefreshing() {
        ...
        mHeaderView.setState(HeaderListView.STATE_REFRESHING);
    }
    ...
    public void setPullLoadEnable(boolean enable) {
        ...
        if (!mEnablePullLoad) {
            ...
            //mPullLoading = false;
            if (mFooterView == null) {
                mFooterView = new FooterListView(m_context);
            ...
            mFooterView.setState(FooterListView.STATE_NORMAL);
    ...
    private void updateHeaderHeight(float delta) {
        ...
        if (mEnablePullRefresh && !mPullRefreshing) { // 未处于刷新状态，更新箭头
            if (mHeaderView.getVisiableHeight() > mHeaderViewHeight) {
                mHeaderView.setState(HeaderListView.STATE_READY);
            } else {
                mHeaderView.setState(HeaderListView.STATE_NORMAL);
            }
        }
    ...
    private void updateFooterHeight(float delta) {
        ...
        if (mEnablePullLoad && !mPullLoading) {
            if (height > PULL_LOAD_MORE_DELTA) { // height enough to invoke load
                // more.
                mFooterView.setState(FooterListView.STATE_READY);
            } else {
                mFooterView.setState(FooterListView.STATE_NORMAL);
            }
        }
...
//		setSelection(mTotalItemCount - 1); // scroll to bottom
    ...
    private void startLoadMore() {
        mPullLoading = true;
        mFooterView.setState(FooterListView.STATE_LOADING);
